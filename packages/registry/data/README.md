...
Versioned artifacts behind every docfonts verdict. Three layers, kept separate (provenance vs proof
vs public verdict). `records.json` is the hand-curated source of truth; the corpus manifests are
generated by `scripts/import-corpus.ts`. (`scripts/import-research.ts` seeded the registry originally
but is no longer authoritative - see its header.) Schemas: `../src/types.ts`.
